     ...
     <li class="nav-item">
         ...
         <div id="collapseSales" class="collapse" aria-labelledby="headingSales"
             ...
             <div class="bg-white py-2 collapse-inner rounded">
                 ...
                 <a class="collapse-item" href="/order/list/all">주문 전체목록</a>
                 <a class="collapse-item" href="/order/list/ready">발주/발송 관리</a>
                 <a class="collapse-item" href="<c:url value='/order/list/delivery'/>">배송현황 관리</a>
                 <a class="collapse-item" href="<c:url value='/order/list/calsel'/>">취소접수내역 관리</a>
                 <a class="collapse-item" href="<c:url value='/order/list/refund'/>">환불완료 목록</a>
             </div>
         </div>
     </li>
     ...
     <li class="nav-item">
         ...
         <div id="collapseAdmin" class="collapse" aria-labelledby="headingAdmin"
             ...
             <div class="bg-white py-2 collapse-inner rounded">
                 ...
                 <a class="collapse-item" href="/admin/list/admin">관리자 목록</a>
                 <a class="collapse-item" href="/admin/register/admin">관리자 등록</a>
             </div>
         </div>
     </li>
    <!-- Divider -->

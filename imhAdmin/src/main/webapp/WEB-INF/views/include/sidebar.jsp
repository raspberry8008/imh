     ...
     <li class="nav-item">
         ...
         <div id="collapseSales" class="collapse" aria-labelledby="headingSales"
             ...
             <div class="bg-white py-2 collapse-inner rounded">
                 ...
                 <a class="collapse-item" href="/admin/list/order">주문 전체조회</a>
                 <a class="collapse-item" href="<c:url value='/admin/list/ready?condition=orderState&keyword=2&condition=orderState&keyword=3'/>">발주/발송 관리</a>
                 <a class="collapse-item" href="/admin/list/delivery">배송현황 관리</a>
                 <a class="collapse-item" href="/admin/list/cancel">취소관리</a>
             </div>
         </div>
     </li>
     ...
     <li class="nav-item">
         ...
         <div id="collapseAdmin" class="collapse" aria-labelledby="headingAdmin"
             ...
             <div class="bg-white py-2 collapse-inner rounded">
                 ...
                 <a class="collapse-item" href="/admin/list/admin">관리자 현황</a>
